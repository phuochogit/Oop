...
public:
    ...
    virtual int tinhtienchomotchitietmaytheomasodon(string);
    int laysoluongchitietthanhphan();
    virtual int tinhtienchomotchitietmaytheomasophuc(string);
...
public:
    ...
    int tinhtienchomotchitietmaytheomasodon(string);
};
...
public:
    ...
    chitiet* timkiemmotchitietmaytheomaso(const string);
    int tinhtienchomotchitietmaytheomaso(string);
    int tinhtienchomotchitietmaytheomasophuc(string);
};
class may
{
private:
...
int main()
{
    ...
    int tongtien = abc.tinhtienchomotchitietmaytheomaso("3");//Test 2,3 đều bằng 3.
    cout << "Tong tien cua chi tiet may theo ma so " << " la: " << tongtien << endl;
    return 0;
}
void may::nhap()
{
...
int may::tinhtienchomotchitietmaytheomaso(string ms)
{
    int tongtien = 0;
    for (int i = 0; i < n; i++)
    {
        if (ct[i]->laysoluongchitietthanhphan()==0)
        tongtien = tongtien +ct[i]->tinhtienchomotchitietmaytheomasodon(ms);
        if (tongtien!=0)
            return tongtien;
        if(ct[i]->laysoluongchitietthanhphan()!=0)
        tongtien = tongtien + ct[i]->tinhtienchomotchitietmaytheomasophuc(ms);
    }
    return tongtien;
...
int chitiet::tinhtienchomotchitietmaytheomasodon(string ms)
{

}
int chitiet::laysoluongchitietthanhphan()
{
    return soluongchitietthanhphan;
}
int chitiet::tinhtienchomotchitietmaytheomasophuc(string)
{

}
string chitiet::laymaso()
{
    return maso;
}
void don::nhap()
...
int don::tinhtienchomotchitietmaytheomasodon(string ms)
{
    if(ms==maso)
        return giatien;
    return 0;
...
int phuc::tinhtienchomotchitietmaytheomaso(string ms)
{
    for (int i = 0; i < soluongchitietthanhphan; i++)
    {
        if (danhsachchitietthanhphan[i]->laysoluongchitietthanhphan()==0)
            giatien = giatien +danhsachchitietthanhphan[i]->tinhtienchomotchitietmaytheomasodon(ms);
        if (giatien!=0)
            return giatien;
        if(danhsachchitietthanhphan[i]->laysoluongchitietthanhphan()!=0)
            giatien = giatien + danhsachchitietthanhphan[i]->tinhtienchomotchitietmaytheomasophuc(ms);
    }
    return giatien;
}
int phuc::tinhtienchomotchitietmaytheomasophuc(string ms)
{
